...
//import com.ivanov.scc.service.impl.RoundingService;
...
//    |-> List of all the roundings per accounts for the last week
...
//
//    /*
//    Test endpoint for rounding up transactions for specific account for the past 7 days. You must specify accountUid in parameters
...
//    public PutMoneyResponse roundMeUpAndPutInSaving(@RequestParam String savingsGoalUid, @RequestParam String accountUid){
//        Amount roundings = roundingService.roundUpTransactionForAccount(accountUid);
//        return starlingClient.putMoneyToSavingsGoal(savingsGoalUid,accountUid,roundings);
//    }
//}
